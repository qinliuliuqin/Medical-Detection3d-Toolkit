...
1. positive: landmark voxels-voxels of different landmarks should have different voxel value (e.g., for the landmark ith, voxels of this landmark can be set to i.)
2. 0: background voxels
3. -1: invalid voxles  
